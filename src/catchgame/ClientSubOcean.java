...
public class ClientSubOcean extends AbstractOcean
{
	...
	/*
	 * public void updateFishPopulationsFromServer(){ SubOceanFishStatePacket
	 * codStatePacket=new SubOceanFishStatePacket(super.codPopulation.size(), 100);
	 * try{ toServer.writeObject(codStatePacket);
	 * System.out.println("Sent codStatePacket"); FishPacketsPacket
	 * fishPacketPacket=(FishPacketsPacket)fromServer.readObject();
	 * addPacketOfCod(fishPacketPacket.codPopulation); }catch(IOException ex){
