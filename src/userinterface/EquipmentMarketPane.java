...
public class EquipmentMarketPane extends VBox
{
	...
	public VBox saleGridPaneContainer = new VBox();
	...
	public EquipmentMarketPane(String name)// , EventHandler<ActionEvent> buyEquipmentAction)
	{
		...
		saleGridPaneContainer.getChildren().addAll(lblPrices, saleGridPane);
		
		this.getChildren().add(saleGridPaneContainer);
		

		lblPrices.setAlignment(Pos.CENTER);
