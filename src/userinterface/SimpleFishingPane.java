...
public class SimpleFishingPane extends Pane{
	...
	private Label labelExplanation=new Label("Right now the fish are shown as dots, and"
			+ "when you extract a fish, a fish is removed, "
			+ "and if fish are sent from the server, "
			+ "they are added.  We plan to make this an animation and "
			+ "for it to be more interesting in other ways later.");
